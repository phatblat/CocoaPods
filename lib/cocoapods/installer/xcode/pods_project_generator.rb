        ...
        def install_libraries
          UI.message '- Installing targets' do
            ...
            pod_target_installation_results = Hash[pod_targets.sort_by(&:name).map do |pod_target|
              umbrella_headers_dir = umbrella_headers_by_dir[pod_target.module_map_path.dirname]
              target_installer = PodTargetInstaller.new(sandbox, @project, pod_target, umbrella_headers_dir)
